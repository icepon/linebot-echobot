...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		// Reply only when message sent is in 'text' format
			...
			$action2 = array (
				New \LINE\LINEBot\TemplateActionBuilder\UriTemplateActionBuilder("กรมธรรม์ไม่มีเบอร์ติดต่อ", "tel:1581")
			);
			$column1 = new \LINE\LINEBot\MessageBuilder\TemplateBuilder\CarouselColumnTemplateBuilder($nb21, $nb22,$imgurl, $action1);
  			$column2 = new \LINE\LINEBot\MessageBuilder\TemplateBuilder\CarouselColumnTemplateBuilder($nb23, $nb24,$imgurl2, $action2);
			...
			$action1 = array (
				//New \LINE\LINEBot\TemplateActionBuilder\UriTemplateActionBuilder("ติดต่อลูกค้า ✆", "tel:1581"),
				New \LINE\LINEBot\TemplateActionBuilder\PostbackTemplateActionBuilder("ติดต่อลูกค้า ✆","nophone"),
				...
				New \LINE\LINEBot\TemplateActionBuilder\UriTemplateActionBuilder("สอบถามเบี้ยฯ+เงื่อนไข", "tel:023538888")
			);
