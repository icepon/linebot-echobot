	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			$actions = array (
				...
				New \LINE\LINEBot\TemplateActionBuilder\UriTemplateActionBuilder("ส่งต่อข้อความ", "src:https://d.line-scdn.net/r/web/social-plugin/js/thirdparty/loader.min.js"),
